from collective.netopia.mobilpay.payment.request.base_request import BaseRequest
...
class Card(BaseRequest):
    ...
    def encrypt(self, x509_file_path):
        if (
            ...
            or self._orderId is None
            or isinstance(self._invoice, Invoice) is not True
        ):
            raise Exception(
